...
/**
 * Основной путь инвалидации — вебхук из Directus (directus/flows/revalidate.md),
 * а это фоновая страховка на случай, если Flow отключили или запрос не дошёл.
 *
 * Час здесь уже стоял и был снят: экономия на запросах к CMS вышла копеечной,
 * а цена оказалась заметной. Если сборка почему-либо взяла статический фолбэк
 * вместо контента из CMS, минута означает «починится само», час — «висит час».
 * Для страховочного механизма это решающее свойство.
 */
